    ...
    fluidPage(
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          sliderInput("percent_working_age", "Working age (%) - populated based on WB data",
                      min = 0, max = 100, value = 60, step = 1),
          sliderInput("percent_workforce_participation", "Workforce participation rate (%) - populated based on WB data",
                      min = 0, max = 100, value = 66, step = 1),
          sliderInput("percent_informal", "Informal workers (%)",
                      min = 0, max = 100, value = 80, step = 1),
          sliderInput("inflation_rate", "Inflation rate (%) - populated based on WB data",
